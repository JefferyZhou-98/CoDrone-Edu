...
# plt.figure(dpi = 200)
# plt.plot(t, roll, label=r"$\omega_x$", color="tab:blue", linewidth = 2)
# plt.plot(t, pitch, label=r"$\omega_y$", color="tab:green", linewidth = 2)
# plt.plot(t, yaw, label=r"$\omega_z$", color="tab:orange", linewidth = 2)
